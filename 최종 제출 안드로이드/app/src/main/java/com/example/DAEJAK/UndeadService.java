...
public class UndeadService extends Service {
    ...
    public void initializeNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel("1", "channel_name", NotificationManager.IMPORTANCE_LOW);
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            target = "http://175.210.156.100/checklist2.php";
        }
    ...
    public void showNoti(String level, String date, String name) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            manager.createNotificationChannel(
                    new NotificationChannel(
                            CHANNEL_ID, CHANEL_NAME, NotificationManager.IMPORTANCE_HIGH));
        ...
        builder.setSmallIcon(R.mipmap.ic_launcher); //알림창 아이콘
